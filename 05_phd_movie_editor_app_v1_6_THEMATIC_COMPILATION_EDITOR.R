...
#
# V1.6 adds an interactive thematic-compilation editor with inclusion
# checkboxes, chapter reordering, and in-page chapter preview. It also
# retains the timestamp normalization and range-enabled master MP4.
